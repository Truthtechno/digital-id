    ...
    <div :id="`Theme${theme}`">
      ...
      >
        <head>
          ...
          <meta
            name="author"
            content="The XEN Digital Business Card Generator"
          />
          <meta name="url" content="https://xen-hub.com/vcard/xcp/" />
          <meta name="designer" content="XEN Capital Partners" />
          <meta
            property="og:title"
        ...
        <body id="body">
          ...
          >
            ...
            <div id="copyView" ref="copyView">
              <p class="textColor">
                Copy and send the URL to share my Digital Business Card
              </p>
              <button
                id="copyURL"
                :style="{
