  ...
  <footer class="mt-32 mx-4 flex flex-col">
    <div class="flex flex-col justify-center items-center">
     <!-- <div
      ...
      <p class="font-extrabold text-xl mt-2 leading-tight">DIGITAL SOLUTIONS</p>
    </div>
    <p class="mt-6 text-center text-gray-400">
      Developed By
      <a
        class="text-yellow-500 font-extrabold hover:text-yellow-300 focus:text-yellow-300 transition-colors duration-200"
