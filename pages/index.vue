  ...
  >
      ...
      >
        ...
        <button
          class="
            ...
            select-none
          "
          :class="showPreview ? 'bg-gray-700' : 'bg-yellow-500'"
    ...
    <div class="px-4">
      ...
      <p class="mt-8 text-lg md:text-xl w-full md:w-3/4 text-gray-200">
        Revolutionize your business with a modern 
        and secure digital identification system.
      </p>
      <ul class="mt-4 text-gray-400">
        <li>-&ensp;This tool is a digital ID generator</li>
        <li>-&ensp;Generate unlimited digital IDs for staff marketing and even clientele</li>
        <li>-&ensp;Share Buisness ID and contact details effortlessly via QR code or link</li>
        <li>-&ensp;Host IDs on our short URL (e.g., xen-hub.com/businessID/username)</li>
        <li>-&ensp;Optionally, host digital IDs for free on your Company's domain</li>
      </ul>
    ...
    <div class="md:grid md:grid-cols-2">
      <div class="px-4 mt-32">
        ...
        <div id="step-2" class="mt-16">
          ...
          <div class="stepC mt-6">
            ...
            <input
              ...
              placeholder="Manager, Administrator etc"
              class="
                mt-2
                px-4
                w-full
        ...
        <div id="step-3" class="mt-16">
          <h2 class="font-extrabold text-2xl">Primary Actions (Quick Links)</h2>
          <draggable
        ...
        <div id="step-4" class="mt-16">
          <h2 class="font-extrabold text-2xl">Secondary Actions (Social Media)</h2>
          <draggable
        ...
        <div id="step-5" class="mt-16">
          <h2 class="font-extrabold text-2xl">Business Content</h2>
          <div class="stepC">
            <draggable
              v-model="featured"
              handle=".drag"
          ...
          <div class="stepC mt-6">
            <div class="flex items-center">
              <div
                ...
                "
                :class="{
                  'bg-yellow-500 hover:bg-yellow-300 focus:bg-yellow-300':
                    footerCredit,
                }"
                tabindex="0"
          ...
          <div class="stepC mt-6">
            ...
            <input
              ...
              class="
                ...
                hover:border-gray-600
              "
              placeholder="https://your-business.com/businessID/username"
            />
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
